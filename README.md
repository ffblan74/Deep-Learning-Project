...
It uses a pre-trained convolutional neural network (ResNet50) to extract visual features or to load raw image pixels.
...
It executes the training loop, and saves the final optimized model into an `.h5` file.
...
If you wish to retrain the model from scratch, run:
